...
if __name__ == '__main__':
    ...
    api_test.yr_location_forecast_test(yr_constants.AANDALSNES)
    api_test.find_snowy_days(yr_constants.AANDALSNES)
    #api_test.yr_snow_test()
    #logging.info('yr tests completed')
    api_test.map_res_avy(yr_constants.AANDALSNES_LAT_LOT)
